...
public class monthadapter extends RecyclerView.Adapter<monthadapter.MyViewHolder> {
    ...
    ArrayList<monthmodel> restos;
    fav cartmodels;
    DatabaseReference reference;



    public monthadapter(Context c, ArrayList<monthmodel> r) {
        context = c;
        restos = r;
    }
    ...
    public monthadapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new monthadapter.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.homecard,parent,false));
    }
