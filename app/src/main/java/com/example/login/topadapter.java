...
public class topadapter extends RecyclerView.Adapter<topadapter.MyViewHolder> {
    ...
    ArrayList<topmodel> restos;
    fav cartmodels;
    DatabaseReference reference;



    public topadapter(Context c, ArrayList<topmodel> r) {
        context = c;
        restos = r;
    }
    ...
    public topadapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new topadapter.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.homecard,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull topadapter.MyViewHolder holder, final int position) {
